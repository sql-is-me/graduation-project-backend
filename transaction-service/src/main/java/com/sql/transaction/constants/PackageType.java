...
public class PackageType {
    ...
    public static final BigDecimal P10_PRICE = new BigDecimal("9.00");

    /** 30课时套餐，原价30元，8.5折优惠 */
    public static final String P30 = "p30";
    public static final int P30_HOURS = 30;
    public static final BigDecimal P30_PRICE = new BigDecimal("25.50");

    /** 50课时套餐，原价50元，8折优惠 */
    public static final String P50 = "p50";
    public static final int P50_HOURS = 50;
    public static final BigDecimal P50_PRICE = new BigDecimal("40.00");
