...
import com.ruoyi.common.auth.annotation.LoginRequired;
import com.ruoyi.common.auth.annotation.RequiresType;
import com.ruoyi.common.auth.util.AuthUtil;
...
public class PermissionAspect implements Ordered {
    ...
    public static final String POINTCUT_SIGN =
            "@annotation(com.ruoyi.common.auth.annotation.LoginRequired) || "
                    + "@annotation(com.ruoyi.common.auth.annotation.RequiresType) || "
                    + "@within(com.ruoyi.common.auth.annotation.LoginRequired) || "
                    + "@within(com.ruoyi.common.auth.annotation.RequiresType)";
