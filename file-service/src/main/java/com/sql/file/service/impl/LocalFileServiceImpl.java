...
public class LocalFileServiceImpl implements FileService {
    ...
    private static final String DEFAULT_COACH_PHOTO = "/default_coach_photo.jpg";
    private static final String DEFAULT_CHILD_PHOTO = "/default_child_photo.jpg";
     ...
     * 教练照片存储在本地的根路径
     */
    @Value("${file.coach-photo-path}")
    private String localCoachPhotoPath;
    ...
    public String uploadCoachPhoto(MultipartFile file) throws Exception {
        return FileUploadUtils.uploadCoachPhoto(localCoachPhotoPath, file);
    }
    ...
    public void deleteCoachPhoto(String fileUrl) throws Exception {
        if (fileUrl.endsWith(DEFAULT_COACH_PHOTO)) {
            return;
        }
        FileUtils.deleteFile(localCoachPhotoPath + fileUrl);
    }
    ...
    public void deleteChildPhoto(String fileUrl) throws Exception {
        if (fileUrl.endsWith(DEFAULT_CHILD_PHOTO)) {
            return;
        }
