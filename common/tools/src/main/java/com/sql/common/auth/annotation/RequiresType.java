 ...
 *
 * 用户类型体系:
 *   UserTypes.ADMIN   ("0") — 系统管理员 (Admin.adminType = "0")
 *   UserTypes.MANAGER ("1") — 店铺/店铺管理员 (Admin.adminType = "1")
 *   UserTypes.COACH   ("2") — 教练 (User.userType = "1")
 *   UserTypes.VIP     ("3") — 普通会员 (User.userType = "0")
 *
 * 使用示例:
 *   @RequiresType(UserTypes.ADMIN)                           — 仅系统管理员
 *   @RequiresType({UserTypes.ADMIN, UserTypes.MANAGER})      — 系统管理员或店铺管理员
